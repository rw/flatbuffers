...
// TODO:   }
  ...
  fn parent_namespace_test() -> &super::InParentNamespace  {
    // yo
    self.GetPointer::<&super::InParentNamespace>(VT_PARENT_NAMESPACE_TEST)
  }
...
fn CreateMonsterDirect(
    ...
    inventory: Option<std::vector<u8>> /* = nullptr */,
    color: Color  /* = Color_Blue */,
    test_type: Any  /* = Any_NONE */,
    test: flatbuffers::Offset<void>  /* = 0 */,
    test4: Option<std::vector<Test>> /* = nullptr */,
    testarrayofstring: Option<std::vector<flatbuffers::Offset<flatbuffers::String>>> /* = nullptr */,
    testarrayoftables: Option<std::vector<flatbuffers::Offset<Monster>>> /* = nullptr */,
    enemy: flatbuffers::Offset<Monster>  /* = 0 */,
    testnestedflatbuffer: Option<std::vector<u8>> /* = nullptr */,
    testempty: flatbuffers::Offset<Stat>  /* = 0 */,
    testbool: bool  /* = false */,
    testhashs32_fnv1: i32  /* = 0 */,
    testhashu32_fnv1: u32  /* = 0 */,
    ...
    testhashs64_fnv1a: i64  /* = 0 */,
    testhashu64_fnv1a: u64  /* = 0 */,
    testarrayofbools: Option<std::vector<bool>> /* = nullptr */,
    testf: f32  /* = 3.14159 */,
    testf2: f32  /* = 3.0 */,
    testf3: f32  /* = 0.0 */,
    testarrayofstring2: Option<std::vector<flatbuffers::Offset<flatbuffers::String>>> /* = nullptr */,
    testarrayofsortedstruct: Option<std::vector<Ability>> /* = nullptr */,
    flex: Option<std::vector<u8>> /* = nullptr */,
    test5: Option<std::vector<Test>> /* = nullptr */,
