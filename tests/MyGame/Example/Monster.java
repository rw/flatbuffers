...
public final class Monster extends Table {
  ...
  public byte vectorOfEnum(int j) { int o = __offset(90); return o != 0 ? bb.get(__vector(o) + j * 1) : 0; }
  public int vectorOfEnumLength() { int o = __offset(90); return o != 0 ? __vector_len(o) : 0; }
  public ByteBuffer vectorOfEnumAsByteBuffer() { return __vector_as_bytebuffer(90, 1); }
  public ByteBuffer vectorOfEnumInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 90, 1); }
  public boolean mutateVectorOfEnum(int j, byte vector_of_enum) { int o = __offset(90); if (o != 0) { bb.put(__vector(o) + j * 1, vector_of_enum); return true; } else { return false; } }
  ...
  public static void addVectorOfEnum(FlatBufferBuilder builder, int vectorOfEnumOffset) { builder.addOffset(43, vectorOfEnumOffset, 0); }
  public static int createVectorOfEnumVector(FlatBufferBuilder builder, byte[] data) { builder.startVector(1, data.length, 1); for (int i = data.length - 1; i >= 0; i--) builder.addByte(data[i]); return builder.endVector(); }
