...
cp monster_test_generated.rs ../rust/tests/generated_code/
cp -r namespace_test/namespace_test1_generated.rs namespace_test/namespace_test2_generated.rs ../rust/tests/generated_code/namespace_test/
