...
struct MonsterT : public flatbuffers::NativeTable {
  ...
  std::vector<Color> vector_of_enum;
  MonsterT()
      : mana(150),
        hp(100),
        color(Color_Blue),
...
struct Monster FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  const flatbuffers::Vector<int8_t> *vector_of_enum() const {
    return GetPointer<const flatbuffers::Vector<int8_t> *>(VT_VECTOR_OF_ENUM);
  }
  flatbuffers::Vector<int8_t> *mutable_vector_of_enum() {
    return GetPointer<flatbuffers::Vector<int8_t> *>(VT_VECTOR_OF_ENUM);
  }
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           ...
           VerifyOffset(verifier, VT_VECTOR_OF_ENUM) &&
           verifier.VerifyVector(vector_of_enum()) &&
           verifier.EndTable();
  }
  MonsterT *UnPack(const flatbuffers::resolver_function_t *_resolver = nullptr) const;
  void UnPackTo(MonsterT *_o, const flatbuffers::resolver_function_t *_resolver = nullptr) const;
...
struct MonsterBuilder {
  ...
  void add_vector_of_enum(flatbuffers::Offset<flatbuffers::Vector<int8_t>> vector_of_enum) {
    fbb_.AddOffset(Monster::VT_VECTOR_OF_ENUM, vector_of_enum);
  }
  explicit MonsterBuilder(flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
...
inline flatbuffers::Offset<Monster> CreateMonster(
    ...
    flatbuffers::Offset<flatbuffers::Vector<int8_t>> vector_of_enum = 0) {
  MonsterBuilder builder_(_fbb);
  ...
  builder_.add_vector_of_enum(vector_of_enum);
...
inline flatbuffers::Offset<Monster> CreateMonsterDirect(
    ...
    const std::vector<int8_t> *vector_of_enum = nullptr) {
  return MyGame::Example::CreateMonster(
      ...
      vector_of_enum ? _fbb.CreateVector<int8_t>(*vector_of_enum) : 0);
}
...
if (_resolver) (*_resolver)(reinterpret_cast<void **>(&_o->vector_of_non_owning_references[_i]), static_cast<flatbuffers::hash_value_t>(_e->Get(_i))); else _o->vector_of_non_owning_references[_i] = nullptr; } } };
  { auto _e = vector_of_enum(); if (_e) { _o->vector_of_enum.resize(_e->size()); for (flatbuffers::uoffset_t _i = 0; _i < _e->size(); _i++) { _o->vector_of_enum[_i] = (Color)_e->Get(_i); } } };
}
...
inline flatbuffers::Offset<Monster> CreateMonster(flatbuffers::FlatBufferBuilder &_fbb, const MonsterT *_o, const flatbuffers::rehasher_function_t *_rehasher) {
  ...
  auto _vector_of_enum = _o->vector_of_enum.size() ? _fbb.CreateVector((const int8_t*)_o->vector_of_enum.data(), _o->vector_of_enum.size()) : 0;
  return MyGame::Example::CreateMonster(
      _fbb,
      _pos,
      _mana,
