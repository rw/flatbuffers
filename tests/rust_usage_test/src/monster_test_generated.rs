...
impl<'a: 'b, 'b> TestSimpleTableWithEnumBuilder<'a, 'b> {
  pub fn add_color(&mut self, color: Color) {
    self.fbb_.push_slot_default::<Color>(TestSimpleTableWithEnum::VT_COLOR, color, Color::Green);
  }
...
impl<'a: 'b, 'b> StatBuilder<'a, 'b> {
  ...
  pub fn add_val(&mut self, val: i64) {
    self.fbb_.push_slot_default::<i64>(Stat::VT_VAL, val, 0);
  }
  pub fn add_count(&mut self, count: u16) {
    self.fbb_.push_slot_default::<u16>(Stat::VT_COUNT, count, 0);
  }
...
impl<'a: 'b, 'b> ReferrableBuilder<'a, 'b> {
  pub fn add_id(&mut self, id: u64) {
    self.fbb_.push_slot_default::<u64>(Referrable::VT_ID, id, 0);
  }
...
impl<'a: 'b, 'b> MonsterBuilder<'a, 'b> {
  ...
  pub fn add_mana(&mut self, mana: i16) {
    self.fbb_.push_slot_default::<i16>(Monster::VT_MANA, mana, 150);
  }
  pub fn add_hp(&mut self, hp: i16) {
    self.fbb_.push_slot_default::<i16>(Monster::VT_HP, hp, 100);
  }
  ...
  pub fn add_color(&mut self, color: Color) {
    self.fbb_.push_slot_default::<Color>(Monster::VT_COLOR, color, Color::Blue);
  }
  pub fn add_test_type(&mut self, test_type: Any) {
    self.fbb_.push_slot_default::<Any>(Monster::VT_TEST_TYPE, test_type, Any::NONE);
  }
  ...
  pub fn add_testbool(&mut self, testbool: bool) {
    self.fbb_.push_slot_default::<bool>(Monster::VT_TESTBOOL, testbool, false);
  }
  pub fn add_testhashs32_fnv1(&mut self, testhashs32_fnv1: i32) {
    self.fbb_.push_slot_default::<i32>(Monster::VT_TESTHASHS32_FNV1, testhashs32_fnv1, 0);
  }
  pub fn add_testhashu32_fnv1(&mut self, testhashu32_fnv1: u32) {
    self.fbb_.push_slot_default::<u32>(Monster::VT_TESTHASHU32_FNV1, testhashu32_fnv1, 0);
  }
  pub fn add_testhashs64_fnv1(&mut self, testhashs64_fnv1: i64) {
    self.fbb_.push_slot_default::<i64>(Monster::VT_TESTHASHS64_FNV1, testhashs64_fnv1, 0);
  }
  pub fn add_testhashu64_fnv1(&mut self, testhashu64_fnv1: u64) {
    self.fbb_.push_slot_default::<u64>(Monster::VT_TESTHASHU64_FNV1, testhashu64_fnv1, 0);
  }
  pub fn add_testhashs32_fnv1a(&mut self, testhashs32_fnv1a: i32) {
    self.fbb_.push_slot_default::<i32>(Monster::VT_TESTHASHS32_FNV1A, testhashs32_fnv1a, 0);
  }
  pub fn add_testhashu32_fnv1a(&mut self, testhashu32_fnv1a: u32) {
    self.fbb_.push_slot_default::<u32>(Monster::VT_TESTHASHU32_FNV1A, testhashu32_fnv1a, 0);
  }
  pub fn add_testhashs64_fnv1a(&mut self, testhashs64_fnv1a: i64) {
    self.fbb_.push_slot_default::<i64>(Monster::VT_TESTHASHS64_FNV1A, testhashs64_fnv1a, 0);
  }
  pub fn add_testhashu64_fnv1a(&mut self, testhashu64_fnv1a: u64) {
    self.fbb_.push_slot_default::<u64>(Monster::VT_TESTHASHU64_FNV1A, testhashu64_fnv1a, 0);
  }
  ...
  pub fn add_testf(&mut self, testf: f32) {
    self.fbb_.push_slot_default::<f32>(Monster::VT_TESTF, testf, 3.14159);
  }
  pub fn add_testf2(&mut self, testf2: f32) {
    self.fbb_.push_slot_default::<f32>(Monster::VT_TESTF2, testf2, 3.0);
  }
  pub fn add_testf3(&mut self, testf3: f32) {
    self.fbb_.push_slot_default::<f32>(Monster::VT_TESTF3, testf3, 0.0);
  }
  ...
  pub fn add_single_weak_reference(&mut self, single_weak_reference: u64) {
    self.fbb_.push_slot_default::<u64>(Monster::VT_SINGLE_WEAK_REFERENCE, single_weak_reference, 0);
  }
  ...
  pub fn add_co_owning_reference(&mut self, co_owning_reference: u64) {
    self.fbb_.push_slot_default::<u64>(Monster::VT_CO_OWNING_REFERENCE, co_owning_reference, 0);
  }
  ...
  pub fn add_non_owning_reference(&mut self, non_owning_reference: u64) {
    self.fbb_.push_slot_default::<u64>(Monster::VT_NON_OWNING_REFERENCE, non_owning_reference, 0);
  }
...
impl<'a: 'b, 'b> TypeAliasesBuilder<'a, 'b> {
  pub fn add_i8_(&mut self, i8_: i8) {
    self.fbb_.push_slot_default::<i8>(TypeAliases::VT_I8_, i8_, 0);
  }
  pub fn add_u8_(&mut self, u8_: u8) {
    self.fbb_.push_slot_default::<u8>(TypeAliases::VT_U8_, u8_, 0);
  }
  pub fn add_i16_(&mut self, i16_: i16) {
    self.fbb_.push_slot_default::<i16>(TypeAliases::VT_I16_, i16_, 0);
  }
  pub fn add_u16_(&mut self, u16_: u16) {
    self.fbb_.push_slot_default::<u16>(TypeAliases::VT_U16_, u16_, 0);
  }
  pub fn add_i32_(&mut self, i32_: i32) {
    self.fbb_.push_slot_default::<i32>(TypeAliases::VT_I32_, i32_, 0);
  }
  pub fn add_u32_(&mut self, u32_: u32) {
    self.fbb_.push_slot_default::<u32>(TypeAliases::VT_U32_, u32_, 0);
  }
  pub fn add_i64_(&mut self, i64_: i64) {
    self.fbb_.push_slot_default::<i64>(TypeAliases::VT_I64_, i64_, 0);
  }
  pub fn add_u64_(&mut self, u64_: u64) {
    self.fbb_.push_slot_default::<u64>(TypeAliases::VT_U64_, u64_, 0);
  }
  pub fn add_f32_(&mut self, f32_: f32) {
    self.fbb_.push_slot_default::<f32>(TypeAliases::VT_F32_, f32_, 0.0);
  }
  pub fn add_f64_(&mut self, f64_: f64) {
    self.fbb_.push_slot_default::<f64>(TypeAliases::VT_F64_, f64_, 0.0);
  }
